...
exports.createBook = (reqData, callback) => {
    ...
    var stock = typeof (reqData.payload.stock) === 'string' && !isNaN(parseInt(reqData.payload.stock)) ? reqData.payload.stock : false;
    ...
    if(name && price &&  stock && author && publisher){
        ...
        callback(400, { message: "Some fields are are compulsory (name, price, stock, author and publisher)" })
    }
};
